...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyBKc9QPFKt62faT2UiwQvpRqZPAYeN-iwY'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_height					= "480px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
