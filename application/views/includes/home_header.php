...
<head>
    <meta charset="utf-8">
    <title>KNOW - OTG Bootstrap Template</title>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li id="linkLogin">
                                    <a class="page-scroll" style="font-size: 20px; font-weight: bold; color:#78FF74;" 
                                    class="login" href="<?php echo site_url();?>/login_cont/login">Login</a>
                                </li>
                               <!--  <li>
                                   <a class="page-scroll" class="login_signup" href="#">Sign Up</a>
